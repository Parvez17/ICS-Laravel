...
<div class="row">
    <div class="col-md-8 col-sm-12">
        <div class="row">
            <div class="col-md-6 col-sm-12">
            <div class= "card">
            <img class="card-img-top" src="/image/envelope/IMG_0283.JPG" alt="Card image cap" style="height:180px">
            <div class="card-body">
            <p class="card-text">Envelope 1</p>
        ...
        <div class= "card">
            <img class="card-img-top" src="/image/envelope/IMG_0278.JPG" alt="Card image cap" style="height:180px">
            <div class="card-body">
            <p class="card-text">Envelope 2</p>
