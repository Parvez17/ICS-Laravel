...
<div class="row">
    <div class="col-md-8 col-sm-12">
        <div class="row">
            <div class="col-md-6 col-sm-12">
            <div class= "card">
            <img class="card-img-top" src="/image/hangtag/IMG_8698.jpg" alt="Card image cap" style="height:180px">
            <div class="card-body">
        ...
        <div class= "card">
            <img class="card-img-top" src="/image/hangtag/IMG_8697.jpg" alt="Card image cap" style="height:180px">
            <div class="card-body">
