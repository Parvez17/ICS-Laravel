...
<div class="row">
    <div class="col-md-8 col-sm-12">
        <div class="row">
            <div class="col-md-6 col-sm-12">
            <div class= "card">
            <img class="card-img-top" src="/image/dairy/IMG_8162.JPG" alt="Card image cap" style="height:180px">
            <div class="card-body">
            <p class="card-text">Dairy 1</p>
        ...
        <div class= "card">
            <img class="card-img-top" src="/image/dairy/IMG_8167.JPG" alt="Card image cap" style="height:180px">
            <div class="card-body">
            <p class="card-text">Dairy 2</p>
