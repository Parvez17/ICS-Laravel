...
<div class="row">
    <div class="col-md-8 col-sm-12">
        <div class="row">
            <div class="col-md-6 col-sm-12">
            <div class= "card">
            <img class="card-img-top" src="/image/calendar/IMG_4370.PNG" alt="Card image cap" style="height:180px">
            <div class="card-body">
            <p class="card-text">Calendar 1</p>
        ...
        <div class= "card">
            <img class="card-img-top" src="/image/calendar/IMG_8232.jpg" alt="Card image cap" style="height:180px">
            <div class="card-body">
            <p class="card-text">Calendar 2</p>
